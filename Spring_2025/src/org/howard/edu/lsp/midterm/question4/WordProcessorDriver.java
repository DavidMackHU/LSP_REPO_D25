...
/**
 * test the functionality of WordProcessor.
 * 
 * 
 * @author David Mack
 */
public class WordProcessorDriver {
    public static void main(String[] args) {
        ...
        // Test case 2: Sentence with multiple occurrences of the same longest word length
        ...
        // Test case 3: Sentence with different word lengths
        WordProcessor wp3 = new WordProcessor("Short tiny words humongous gigantic massive");
        List<String> longestWords3 = wp3.findLongestWords();
        System.out.println("Test 3 - Longest words: " + longestWords3);  
        // Expected Output: ["humongous", "gigantic", "massive"]
